...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
eval('
class Xmobile'.$Pluginname.'Plugin extends XmobileSmartsectionPluginAbstract
{
...
class Xmobile'.$Pluginname.'PluginHandler extends XmobileSmartsectionPluginHandlerAbstract
{
...
');
//////////////////////////////////////////////////////////////////////////
class XmobileSmartsectionPluginAbstract extends XmobilePlugin
{
...
//////////////////////////////////////////////////////////////////////////
class XmobilesmartsectionPluginHandlerAbstract extends XmobilePluginHandler
{
	var $template = 'xmobile_smartsection.html';
	var $categoryTableName = 'smartsection_categories';
	var $itemTableName = 'smartsection_items';
...
//////////////////////////////////////////////////////////////////////////
	function __construct($mydirname,$db)
	{
		...
		{
			$dirnumber = $regs[2];
			$this->categoryTableName = 'smartsection'. $dirnumber . '_categories';
			$this->itemTableName = 'smartsection'. $dirnumber . '_items';
		}
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
