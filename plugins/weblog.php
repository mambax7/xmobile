...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
eval('
class Xmobile'.$Pluginname.'Plugin extends XmobileWeblogPluginAbstract
{
...
class Xmobile'.$Pluginname.'PluginHandler extends XmobileWeblogPluginHandlerAbstract
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class XmobileWeblogPluginAbstract extends XmobilePlugin
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class XmobileWeblogPluginHandlerAbstract extends XmobilePluginHandler
{
	var $moduleDir = 'weblog';
	var $categoryTableName = 'weblog_category';
	var $itemTableName = 'weblog';

	var $template = 'xmobile_weblog.html';
...
//	var $item_order_sort = 'DESC';
	...
	var $new_id = 0;
	var $weblog_cat_post_array = array();
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function __construct($mydirname,$db)
	{
		...
		{
			$number = $matches[1];
			$this->categoryTableName = 'weblog'.$number.'_category';
			$this->itemTableName = 'weblog'.$number;
		}
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
